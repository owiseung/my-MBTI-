"""MBTI - 포켓몬 매칭 데이터
app.py와 pages/ 안의 여러 페이지에서 공통으로 import해서 씁니다.
"""
...
COMPATIBLE_MBTI = {}
for _a, _b, _reason in COMPATIBLE_PAIRS:
    COMPATIBLE_MBTI[_a] = {"partner": _b, "reason": _reason}
    COMPATIBLE_MBTI[_b] = {"partner": _a, "reason": _reason}


def get_sprite_url(dex: int) -> str:
    """포켓몬 도감번호로 공개 스프라이트 이미지 URL을 반환합니다."""
